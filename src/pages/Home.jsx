  ...
  return (
    ...
    <div className="w-full overflow-x-hidden mt-15">
      ...
      <div className="mt-8 sm:mt-10 px-4 sm:px-8 md:px-12 lg:px-20 flex flex-col items-center">
        {/* Top large headings */}
        <div className="text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-center leading-tight" style={{ fontFamily: 'Sora, sans-serif', fontWeight: '700', letterSpacing: '-0.03em' }}>
